...
class AudioIngest:
    ...
    def find_media(self, directory: str) -> List[MediaFile]:
        """
        ◬ The Origin — Discovers all media files recursively.
    ...
    def load_audio(self, file_path: str) -> AudioTensor:
        """
        ◬ The Origin — Loads audio as 16kHz mono float32 tensor via ffmpeg.
    ...
    def get_device_config(self, override: Optional[str]) -> DeviceConfig:
        """
        𓃀 Witnesses GPU/CPU availability without side effects.
